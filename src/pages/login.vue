...
const autocomplete = useLocalStorage('autocomplete', 'on')
</script>

<template>
  <div flex="~ col" w-screen h-screen bg="gray-100 dark:zinc-900">
    ...
    >
      ...
      <el-checkbox v-model="autocomplete" mt="-3" true-label="on" false-label="new-password" label="记住密码" />
